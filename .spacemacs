...
you should place your code here."
  ...
  (setq org-agenda-files (quote ("~/Dropbox/todos")))
  ...
  (add-to-list 'load-path "/home/josh/.emacs.d/own_libraries/")
  (add-hook 'text-mode-hook 'spacemacs/toggle-visual-line-navigation-on)
  ;;(spacemacs/declare-prefix-for-mode 'treemacs-mode "o" "treemacs-menu")
  (spacemacs/set-leader-keys-for-major-mode 'treemacs-mode
    "mrc" 'treemacs-add-and-display-current-project
    "mrt" 'treemacs
    )
