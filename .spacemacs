...
you should place your code here."
  ...
  (setq org-agenda-files (quote ("~/Documents/org" "~/Documents/todos")))
  ...
  (setq user-mail-address	"jobrud314@gmail.com"
        user-full-name	"Joshua Brudnak")
